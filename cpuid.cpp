...
#define PROC_INTEL_486SL        "INTEL 486S"
...
void map_mname(int family, int model, const char *v_name, char *m_name)
{
    ...
    if (!strncmp("AuthenticAMD", v_name, 12)) {
        ...
        case 5: // K6
            ...
            case 2:
            case 3:
                strcpy (m_name, PROC_AMD_K5);
                break;
            case 6:
            case 7:
                strcpy (m_name, PROC_AMD_K6);
                break;
            case 8:
                strcpy (m_name, PROC_AMD_K6_2);
                break;
            case 9:
            case 10:
            case 11:
        ...
        case 6: // Athlon
            ...
            strcpy (m_name, PROC_AMD_ATHLON);
            break;
        }
    }
    else if (!strncmp("GenuineInte", v_name, 12)) {
        switch (family) { // extract family code
        case 4:
            switch (model) { // extract model code
            case 0:
            case 1:
                strcpy (m_name, PROC_INTEL_486DX);
                break;
            case 2:
                strcpy (m_name, PROC_INTEL_486SX);
                break;
            case 3:
                strcpy (m_name,  PROC_INTEL_486DX2);
                break;
            case 4:
                strcpy (m_name, PROC_INTEL_486SL);
                break;
            case 5:
                strcpy (m_name,  PROC_INTEL_486SX2);
                break;
            case 7:
                strcpy (m_name,  PROC_INTEL_486DX2E);
                break;
            case 8:
                strcpy (m_name, PROC_INTEL_486DX4);
                break;
            }
            break;
        ...
        case 5:
            ...
            case 2:
            case 3:
                strcpy (m_name,  PROC_INTEL_PENTIUM);
                break;
            case 4:
                strcpy (m_name,PROC_INTEL_PENTIUM_MMX);
                break;
            }
            break;
        ...
        case 6:
            switch (model) { // extract model code
            case 1:
                strcpy (m_name,  PROC_INTEL_PENTIUM_PRO);
                break;
            case 3:
            case 5:
                strcpy (m_name,  PROC_INTEL_PENTIUM_II);
                break;  // actual differentiation depends on cache settings
            case 6:
                strcpy (m_name, PROC_INTEL_CELERON);
                break;
            case 7:
            case 8:
            case 10:
                strcpy (m_name, PROC_INTEL_PENTIUM_III);
                break;  // actual differentiation depends on cache settings
            }
            break;
        ...
        case 15 | (0x00 << 4): // family 15, extended family 0x00
            switch (model) {
            case 0:
                strcpy (m_name,  PROC_INTEL_PENTIUM_4);
                break;
            }
            break;
        }
        ...
        strcpy (m_name, PROC_CYRIX);
    }
    else if (!strncmp("CentaurHauls", v_name, 12)) {
        strcpy (m_name, PROC_CENTAUR);
    }

    if (!m_name[0]) {
        strcpy (m_name,  PROC_UNKNOWN);
    }
}
